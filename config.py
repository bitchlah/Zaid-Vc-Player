...
OWNER_NAME = getenv("OWNER_NAME", "ALBY")
OWNER_USERNAME = getenv("OWNER_USERNAME", "Timesisnotwaiting")
ALIVE_NAME = getenv("ALIVE_NAME", "ALBY")
BOT_USERNAME = getenv("BOT_USERNAME", "Alby_Robot")
OWNER_ID = getenv("OWNER_ID", "1441342342")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "ALBY_Assistant")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "ruangdiskusikami")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "ruangprojects")
